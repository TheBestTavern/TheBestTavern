...
{
    private string[] gatheringScenetexts = { "이곳은 채집을 할 수 있는 산입니다." ," 이곳에 있는 나무나 수풀들을 눌러 재료를 얻을 수 있습니다.", "위에 있는 보따리가 가득 차면 더이상 채집을 할 수 없으며", "간혹 가다 야생 동물이 튀어나올 수 있으니 조심하시기 바랍니다." , "이제 요리를 하러 가보도록 하죠"};
